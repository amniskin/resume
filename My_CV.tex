...
\cventry{2012--2015}{Bachelor of Science in Mathematics with Minors in Physics and English}{Florida International University}{Miami}{\textit{GPA -- 3.64 (3.79 in major) out of 4.00}}{Graduated Cum Laude}  % Arguments not required can be left empty
\cventry{2010--2011}{Associate of Arts}{Miami Dade College}{Miami}{\textit{GPA -- 3.74 out of 4.00}}{Graduated with Honors}
...
\cventry{2015--2016}{Computer Science Instructor}{\textsc{Florida Vocation Institute}}{Miami}{}{
  \begin{itemize}
    \item Assisted in constructing the school's curriculum.
    \item Taught courses in HTML, CSS, CSS-Frameworks, JavaScript, SQL, MongoDB, NodeJS, Functional-Programming, and Basic-Logic.
    \item Designed a free online course intended to teach aspiring students about the above subjects through interesting projects (www.fvi-grad.com)
  \end{itemize}}
\cventry{2010--2015}{Math/Science/Computing Tutor}{\textsc{Wyzant}}{Miami}{}{
  \begin{itemize}
    \item Cofounded a successful income generating tutoring company (www.Math-Busters.com)
    \item Tutored all levels of students - from Elementary School to upper-level University students.
    \item A five star rating on www.Wyzant.com with over 400 hours of Wyzant sessions logged.
  \end{itemize}}
...
\cvitem{Advanced}{\textsc{JavaScript}, \textsc{HTML}, \textsc{Python*}, \textsc{R*}}
\cvitem{Intermediate}{\textsc{Clojure}, \textsc{Scheme}, \textsc{Hoplon}, \textsc{CSS}, \textsc{MySQL}, \textsc{PostgreSQL}, \textsc{NodeJS}}
\cvitem{Basic}{\textsc{Java}, \textsc{Haskell}, \textsc{MongoDB}, \textsc{Latex}, \textsc{Matlab}, \textsc{Octave}}
