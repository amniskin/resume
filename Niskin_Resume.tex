...
\cvitem{Advanced}{Spanish | \textsc{JavaScript}, \textsc{HTML}, \textsc{Python}, \textsc{R}, \textsc{Bash}}
\cvitem{Intermediate}{Hebrew | \textsc{Clojure}, \textsc{Scheme}, \textsc{Hoplon}, \textsc{CSS}, \textsc{MySQL}, \textsc{PostgreSQL}, \textsc{NodeJS}, \textsc{Hadoop}}
\cvitem{Basic}{German | \textsc{Java}, \textsc{Haskell}, \textsc{MongoDB}, \textsc{Latex}, \textsc{Matlab}, \textsc{Octave}, \textsc{C++}}
%%% }}}
...
%% \cvlistdoubleitem{Algebraic Geometry}{Differential Geometry}
\cvlistdoubleitem{Abstract Algebra (1, 2, Algebraic Geometry)}{Advanced Calculus in $\mathbb{R}^n$ (1, 2, Differential Geometry)}
...
\cventry{2015--2016}{Computer Science Instructor}{\textsc{Florida Vocation Institute}}{Miami, FL}{}{
	\begin{itemize}
		\item Taught and created syllabi for courses in HTML, CSS, CSS-Frameworks, JavaScript, SQL, MongoDB, NodeJS, Functional-Programming, the Unix environment, and Basic-Logic
		\item Created a free online project-based introductory course (currently live at www.fvi-grad.com)
	\end{itemize}}
\cventry{2010--2015}{Co-founder and Math/Science/Computing Tutor}{Math-Busters (www.Math-Busters.com)}{Miami, FL}{}{
	\begin{itemize}
		...
		\item Maintained a perfect five-star rating on Wyzant.com (with 100+ ratings and 450+ hours logged)
	\end{itemize}}
%%%}}}
