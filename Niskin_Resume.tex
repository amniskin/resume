...
\cvitem{Advanced}{Spanish | \textsc{Clojure}, \textsc{Python}, \textsc{R}, \textsc{PSQL}, \textsc{Bash} | Pandas, Matplotlib, SKLearn, PyMC, etc.}
\cvitem{Intermediate}{Hebrew | \textsc{Hoplon}, \textsc{MySQL}, \textsc{NodeJS}, \textsc{Hadoop} | ggplot, dplyr, etc.}
\cvitem{Basic}{German, Russian | \textsc{Java}, \textsc{Scala}, \textsc{MongoDB}, \textsc{Latex}, \textsc{Matlab}, \textsc{C++} | git}
%%% }}}
...
\cventry{2018-Present}{Quantitative Researcher}{\textsc{BlackRock Inc.}}{San Francisco, CA}{Systematic Active Equity}{
	\begin{itemize}
		\item Responsible for onboarding new data sources, building models for alpha generation, and general market research.
		\item Assisted in building internal research tools to streamline the research process
	\end{itemize}}
